...
Life-ops writes only under ``ops/``. ``public/memes/`` prefixes are kept so
this app can share a bucket with ``sethweiland/memes`` without writing there.
...
Queue and usage JSON are ops data and must never be written under ``public/``.
"""
