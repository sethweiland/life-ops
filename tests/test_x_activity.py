...
class LifeNavXTests(unittest.TestCase):
    def test_x_is_life_nav_not_meme_tool(self):
        """X stays a peer tab; Grok Bot nests under Folders; no meme pipeline subnav."""
        ...
        self.assertNotIn('class="subnav"', nav)
        self.assertNotIn("url_for('generate.start')", nav)
